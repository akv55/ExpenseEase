    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <div className="ml-64 p-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">₹{groupData.balanceReport.totalExpenses.toFixed(2)}</p>
                </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{groupData.balanceReport.expenseCount}</p>
                </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">₹{(groupData.balanceReport.totalExpenses / groupData.members.length).toFixed(2)}</p>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          {activeTab === 'balance' && (
            <div className="p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-6">Balance Report</h2>
          ...
          {activeTab === 'summary' && (
            <div className="p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-6">Expense Summary</h2>
                ...
                <div className="space-y-3">
                  {Object.entries(groupData.expenseSummary.categorySummary).map(([category, data]) => (
                    <div key={category} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">₹{data.totalAmount.toFixed(2)}</p>
              ...
              {/* Member Breakdown */}
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">By Member</h3>
                <div className="space-y-3">
                  {groupData.expenseSummary.memberSummary.map((member, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="font-semibold text-gray-900">₹{member.totalPaid.toFixed(2)}</p>
                        <p className="text-sm text-gray-600">{member.expensesCount} expenses</p>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          {activeTab === 'settlements' && (
            <div className="p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-6">Settlement Suggestions</h2>
              <div className="space-y-4">
                  ...
                  <div key={index} className="flex items-center justify-between p-4 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-gray-900">{suggestion.from.name}</span>
                        <TrendingUp size={16} className="text-green-600" />
                        <span className="font-medium text-gray-900">{suggestion.to.name}</span>
                      </div>
                    </div>
                    <div className="text-right">
                ...
                {groupData.settlementSuggestions.length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">No outstanding settlements in this group.</p>
                  </div>
                )}
              </div>
            </div>
