...
const TransactionDetailsModal = ({
	...
	const isStandalone = typeof open === "undefined";
	...
	if (isStandalone) {
		return (
			<div className="min-h-screen bg-slate-50 flex">
				<Sidebar />
				<main className="flex-1 flex flex-col md:ml-64 px-4 py-6 md:px-8">
					<div className="w-full max-w-5xl mx-auto pt-16 md:pt-0">{detailsCard}</div>
				</main>
			</div>
		);
	}
